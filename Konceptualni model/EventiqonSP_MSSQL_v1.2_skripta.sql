...
/* Created on:     25.12.2015 12:55:22                          */
/*==============================================================*/
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('uporabnik_ima_vlogo') and o.name = 'FK_UPORABNI_UPORABNIK_VLOGA')
alter table uporabnik_ima_vlogo
   drop constraint FK_UPORABNI_UPORABNIK_VLOGA
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('uporabnik_ima_vlogo') and o.name = 'FK_UPORABNI_UPORABNIK_UPORABNI')
alter table uporabnik_ima_vlogo
   drop constraint FK_UPORABNI_UPORABNIK_UPORABNI
go
...
if exists (select 1
            from  sysindexes
           where  id    = object_id('uporabnik_ima_vlogo')
            and   name  = 'uporabnik_ima_vlogo2_FK'
            and   indid > 0
            and   indid < 255)
   drop index uporabnik_ima_vlogo.uporabnik_ima_vlogo2_FK
go

if exists (select 1
            from  sysindexes
           where  id    = object_id('uporabnik_ima_vlogo')
            and   name  = 'uporabnik_ima_vlogo_FK'
            and   indid > 0
            and   indid < 255)
   drop index uporabnik_ima_vlogo.uporabnik_ima_vlogo_FK
go
...
if exists (select 1
           ...
           where  id = object_id('uporabnik_ima_vlogo')
            and   type = 'U')
   drop table uporabnik_ima_vlogo
go
...
create table Vloga (
   ...
   constraint PK_VLOGA primary key nonclustered (nazivVloge)
)
go
...
create table uporabnik_ima_vlogo (
   nazivVloge           varchar(10)          not null,
   uprabniskoIme        varchar(100)         not null,
   constraint PK_UPORABNIK_IMA_VLOGO primary key (nazivVloge, uprabniskoIme)
)
go

/*==============================================================*/
/* Index: uporabnik_ima_vlogo_FK                                */
/*==============================================================*/
create index uporabnik_ima_vlogo_FK on uporabnik_ima_vlogo (
nazivVloge ASC
)
go

/*==============================================================*/
/* Index: uporabnik_ima_vlogo2_FK                               */
/*==============================================================*/
create index uporabnik_ima_vlogo2_FK on uporabnik_ima_vlogo (
uprabniskoIme ASC
)
go
...
alter table uporabnik_ima_vlogo
   add constraint FK_UPORABNI_UPORABNIK_VLOGA foreign key (nazivVloge)
      references Vloga (nazivVloge)
go

alter table uporabnik_ima_vlogo
   add constraint FK_UPORABNI_UPORABNIK_UPORABNI foreign key (uprabniskoIme)
      references Uporabnik (uprabniskoIme)
go

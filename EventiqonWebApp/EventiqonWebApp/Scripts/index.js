$(function(){
    ...
    // globalna spremenljivka lokacijaUporabnika hrani pozicijo, pridobljeno s pomočjo brskalnika 
    // za nadaljne potrebe iskanja (v moji bližini) ipd.
    getLocation();
    ...
    $('.showMapIcon').click(function(element){
        ...
        // Demo izpis lokacije, če jo uporabnik dovoli
        if(lokacijaUporabnika != undefined)
            console.log("Uporabniška lokacija: " + 
                        lokacijaUporabnika.coords.latitude + ", " + lokacijaUporabnika.coords.longitude);
        else
            console.log("Lokacija ni na voljo");
